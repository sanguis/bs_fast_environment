...
Jeweler::Tasks.new do |gem|
  ...
  gem.description = "A ruby gem that can run on a server and quickly create beanstalk branches and deployment roles, as well as wet up databases and nginx vhosts."
